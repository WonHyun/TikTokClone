...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(comments) => "${comments}";

  static String m1(commentCount, value) =>
      "${commentCount} ${Intl.plural(value, zero: 'comments', one: 'comment', other: 'comments')}";

  static String m2(likes) => "${likes}";
